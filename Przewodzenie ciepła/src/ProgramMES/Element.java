...
public class Element {
    ...
    public Element(int i, int j, Node[] nodes , double alfa , double ro , double k , double c) throws FileNotFoundException {
        ...
        for (int g = 0; g < 4; g++) {
            if (surfaceForOneElement[g].getPointsForOneSurface()[0].getStatus() == 1 && surfaceForOneElement[g].getPointsForOneSurface()[1].getStatus() == 1) {
        ...
        for (int g = 0; g < 4; g++) {
            if (surfaceForOneElement[g].getPointsForOneSurface()[0].getStatus() == 1 && surfaceForOneElement[g].getPointsForOneSurface()[1].getStatus() == 1) {
                localNumberOfSurfacesThatAreInContactWithTheSurroundings[counter++] = g;

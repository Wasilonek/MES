...
public class Grid {
    ...
    private Grid() throws FileNotFoundException {
        ...
        //Tworzenie wezłów , H	to liczba wezlow po wysokosci , B to liczba wezlow po szerokości , H wysokość , B szerokość
        int count = 0;
        ...
        for (int i = 0; i < globalData.getnB() - 1; i++) {
            for (int j = 0; j < globalData.getnH() - 1; j++) {
                ...
                {
                    alfa = globalData.getAlfaOutsite();
                    ro = globalData.getRoOutsite();
                    k = globalData.getkOutsite();
                    c = globalData.getcOutsite();
                }

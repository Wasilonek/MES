...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (double tau = 0; tau < globalData.getTau(); tau += globalData.getDtau()) {
...
//            System.out.println();
            //System.out.println(globalData.getDtau());
                if(tau%10000 == 0)
...
//            System.out.println();
        ...
        for (int i = 0; i < globalData.getnB(); i++) {
            for (int j = 0; j < globalData.getnH(); j++) {
                if(i == 30)
                    System.out.print("Miejsce połączenia betonu i styropianu: ");
                System.out.printf("%.1f", grid.nodes[nodeNumber++].getTemperature());
                System.out.print("\t\t\t");
            }
            System.out.println("");
